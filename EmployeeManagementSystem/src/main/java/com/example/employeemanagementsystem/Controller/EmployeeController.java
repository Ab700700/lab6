...
public class EmployeeController {
    ...
    public ResponseEntity applyAnnual(@PathVariable String id){
        ...
        else if(Em=='l') return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(new ApiResponse("Employee left",HttpStatus.BAD_REQUEST.toString()));
    ...
    public ResponseEntity promoteEm(@PathVariable String request, @PathVariable String employee){
        ...
        else if(pro=='l') return ResponseEntity.status(HttpStatus.NOT_FOUND).body(new ApiResponse("Employee left",HttpStatus.NOT_FOUND.toString()));
